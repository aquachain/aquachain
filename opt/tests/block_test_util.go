...
func (t *BlockTest) Run() error {
	...
	chain, err := core.NewBlockChain(context.TODO(), db, nil, config, aquahash.NewSharedTesting(), vm.Config{})
	if err != nil {
		return err
	}
	defer chain.Stop()
...
/*
See https://github.com/aquanetwork/tests/wiki/Blockchain-Tests-II
