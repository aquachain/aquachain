...
var (
	...
	AllAquahashProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), MainnetHF, nil, false, big.NewInt(0), common.Hash{}, nil, nil, nil, nil, new(AquahashConfig), nil, big.NewInt(42000000)}
