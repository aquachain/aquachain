...
import "gitlab.com/aquachain/aquachain/p2p/discover"

type BootnodeStringList []string

func (b BootnodeStringList) ToDiscoverNodes() []*discover.Node {
	nodes := make([]*discover.Node, len(b))
	for i, s := range b {
		nodes[i] = discover.MustParseNode(s)
	}
	return nodes
}
...
var MainnetBootnodes = BootnodeStringList{
...
var TestnetBootnodes = BootnodeStringList{
...
// Testnet2 test network. (port 21003)
var Testnet2Bootnodes = BootnodeStringList{}

var EthnetBootnodes = BootnodeStringList{}
