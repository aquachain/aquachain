...
The crypto is documented at https://github.com/aquanetwork/wiki/wiki/Web3-Secret-Storage-Definition
...
import (
	...
	"gitlab.com/aquachain/aquachain/crypto/randentropy"
...
func (ks keyStorePassphrase) GetKey(addr common.Address, filename, auth string) (*Key, error) {
	...
	if key.Address != addr {
		return nil, fmt.Errorf("encrypted key content mismatch: have account %x, want %x", key.Address, addr)
	}
	return key, nil
}
