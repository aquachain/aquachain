...
func TestFastSyncDisabling(t *testing.T) {
	...
	go pmFull.handle(pmFull.newPeer(64, p2p.NewPeer(discover.NodeID{}, "empty", nil), io2))
	go pmEmpty.handle(pmEmpty.newPeer(64, p2p.NewPeer(discover.NodeID{}, "full", nil), io1))
