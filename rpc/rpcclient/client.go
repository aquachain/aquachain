...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for AquaSubscribe requests
}
...
// AquaSubscribe registers a subscripion under the "aqua" namespace.
func (c *Client) AquaSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "aqua", channel, args...)
}
...
func (c *Client) handleResponse(msg *jsonrpcMessage) {
	...
	// indicates success. AquaSubscribe gets unblocked in either case through
	// the op.resp channel.
	defer close(op.resp)
	if msg.Error != nil {
		op.err = msg.Error
...
// A ClientSubscription represents a subscription established through AquaSubscribe.
