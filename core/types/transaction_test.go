...
// at github.com/aquanetwork/tests.
var (
...
func defaultTestKey() (*btcec.PrivateKey, common.Address) {
	key, _ := crypto.HexToBtcec("45a915e4d060149eb4365960e6a7a45f334393093061116b197e3240065ff2d8")
