...
// account array.
func checkStateAccounts(t *testing.T, db aquadb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db aquadb.Database, root common.Hash) error {
...
func checkStateConsistency(db aquadb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(aquadb.Database), srcRoot)
