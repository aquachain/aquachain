...
// PrecompiledContractsHomestead contains the default set of pre-compiled AquaChain
...
// PrecompiledContractsByzantium contains the default set of pre-compiled AquaChain
